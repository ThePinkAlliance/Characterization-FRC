...
public class Robot extends TimedRobot {
    ...
    if (side != Sides.FOLLOWER) {
      ...
      switch (side) {
        ...
        case RIGHT:
          ...
          rightEncoderPosition = () -> (motor.getSelectedSensorPosition(PIDIDX) * encoderConstant); // * -1.0;
          rightEncoderRate = () -> (motor.getSelectedSensorVelocity(PIDIDX) * encoderConstant * 10); // * -1.0;
        ...
        case LEFT:
          ...
          leftEncoderRate = () -> (motor.getSelectedSensorVelocity(PIDIDX) * encoderConstant * 10);
  ...
  public void robotInit() {
    ...
    WPI_TalonFX leftFollowerID0 = setupWPI_TalonFX(5, Sides.FOLLOWER, false);
    leftFollowerID0.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(6, Sides.RIGHT, false);
    WPI_TalonFX rightFollowerID3 = setupWPI_TalonFX(7, Sides.FOLLOWER, false);
